...
namespace DDDarchitect.Domain.DomainModel.EventDomainModel.Events
{
    [EventVersion("AddedEvent", 1)]
    public class AddedEvent : AggregateEvent<Event, EventId>
    {
        #region cto
        public AddedEvent(string eventName, int price, string artist, DateTime date, string description, string imageUrl, CategoryId categoryId)
        {
            EventName = eventName;
            Price = price;
            Artist = artist;
